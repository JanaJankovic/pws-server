const GraphDataModel = require("../models/graphDataModel.js");
...
module.exports = {
  ...
  create: function (req, res) {
    const graph_data = new GraphDataModel({
  ...
  update: function (req, res) {
    ...
    GraphDataModel.findOne({ _id: id }, function (err, graph_data) {
      ...
      graph_data.recipient_id = req.body.recipient_id
        ? req.body.recipient_id
        : graph_data.recipient_id;
      ...
      graph_data.humidity = req.body.humidity
        ? req.body.humidity
        : graph_data.humidity;
      graph_data.moisture = req.body.moisture
        ? req.body.moisture
        : graph_data.moisture;
      graph_data.date_posted = req.body.date_posted
        ? req.body.date_posted
        : graph_data.date_posted;
