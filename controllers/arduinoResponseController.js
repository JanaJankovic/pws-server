var ArduinoresponseModel = require('../models/arduinoResponseModel.js');
...
module.exports = {
    ...
    show: function (req, res) {
        ...
        ArduinoresponseModel.findOne({request_id: id}, function (err, arduinoResponse) {
            if (err) {
    ...
    create: function (req, res) {
        var arduinoResponse = new ArduinoresponseModel({
        ...
        arduinoResponse.save(function (err, arduinoResponse) {
            ...
            ArduinorequestModel.findOne({_id: arduinoResponse.request_id}, function (err, arduinoRequest) {
                if (err) {
                    return res.status(500).json({
   ...
   /**
    ...
    remove: function (req, res) {
        ...
        ArduinoresponseModel.findByIdAndRemove(id, function (err, arduinoResponse) {
            ...
            ArduinorequestModel.findByIdAndRemove(arduinoResponse.request_id, function (err, arduinoRequest) {
                if (err) {
                    return res.status(500).json({
