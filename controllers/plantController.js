      ...
      (err, plant) => {
        ...
        if (!plant) {
          ...
          plant.frequency = req.body.frequency
            ? req.body.frequency
            : plant.frequency;
          plant.moisture_modifier = req.body.moisture_modifier
            ? req.body.moisture_modifier
            : plant.moisture_modifier;
          plant.frequency_modifier = req.body.frequency_modifier
            ? req.body.frequency_modifier
            : plant.frequency_modifier;
